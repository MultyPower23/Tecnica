...
- **`type()`** para consultar el tipo de dato de una variable.
- **Tipos de datos**:
  - `int` (enteros, positivos y negativos, sin decimales)
  - `float` (decimales, requieren `.0` si es un entero "decimal")
  - `complex` (número con parte real e imaginaria, ej. `3 + 5J`)
  - `str` (texto)
...
- 📦 Las listas guardan varios valores de distintos tipos en un solo lugar, accesibles por posición.
