...
- **Diccionarios (`{}`)**: primera mención como estructura para guardar registros (se retoma más a fondo en la Clase 10).
- **`from math import sqrt as raizCuadrada`**: importar una función específica de una librería y renombrarla.
...
- Suma de impares hasta un número dado.
- Cajero automático con menú (consultar, retirar, depositar, salir).
